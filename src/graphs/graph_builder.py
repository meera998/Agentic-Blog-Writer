...
from src.nodes.blog_for_node import BlogNode
...
class GraphBuilder:
    ...
    def build_language_graph(self):
        ...
        self.graph.add_node("title_creation", self.blog_node_obj.title_creation)
        self.graph.add_node("content_generation",self.blog_node_obj.content_generation)
        self.graph.add_node("kurdish_translation",lambda state: self.blog_node_obj.translation({**state, "current_language": "kurdish"}))
        ...
        self.graph.add_conditional_edges(
            ...
            {
                "kurdish":"kurdish_translation",
                "french":"french_translation"
            }
        )
        self.graph.add_edge("kurdish_translation",END)
